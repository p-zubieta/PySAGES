...
class MultiComponentCV(CollectiveVariable):
    """
    Collective variable that returns a tensor-valued quantity.
    It can be combined with other scalar-valued abstract
    CV classes to enforce constructor invariants.
    """
