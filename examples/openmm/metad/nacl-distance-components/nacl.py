...
"""
Metadynamics simulation of Na-Cl in water with OpenMM and PySAGES.
...
Required -- openmmforcefields `conda install -c conda-forge openmmforcefields`
May be required-- `conda install -c conda-forge gcc=12.1.0`
"""
...
from pysages.colvars import DistanceComponents
